...
const en = {
  ...
  nav: {
    ...
    vehicles: "Vehicles",
    trips: "Trips",
    fleetReservations: "Reservation calendar",
  ...
  status: {
    ...
    workOrder: {
      ...
      "needs-parts": "Needs parts (no PR yet)",
...
const fr: MessageTree = {
  ...
  nav: {
    ...
    vehicles: "Véhicules",
    trips: "Trajets",
    fleetReservations: "Calendrier des réservations",
  ...
  status: {
    ...
    workOrder: {
      ...
      "needs-parts": "Pièces requises (sans DA)",
      "pr-submitted": "DA soumise",
      "awaiting-parts": "En attente de pièces",
      completed: "Terminé",
      closed: "Clôturé",
