      ...
      },
      {
        ...
        paragraphs: [
          ...
          [
            ...
            " et ",
            B("pr-submitted"),
            " pour l’approvisionnement : pièces identifiées, puis DA liée ou en cours. Les DA pièces/service véhicule doivent référencer un OT avant de passer en approbation ; la création de la DA enregistre le lien ici automatiquement (needs-parts passe en DA soumise). Le carburant et les fluides consommables (type 4F) sont exemptés.",
          ],
          [
            B("Main-d’œuvre avant clôture : "),
            "un OT ne peut être marqué ",
            B("terminé"),
