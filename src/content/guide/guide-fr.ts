    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Trajets — check-out / retour opérationnel (véhicule réel et odomètre). Missions planifiées et demandes par type de véhicule : voir Demandes.",
          ...
          "Demandes — missions, validation direction, demandes par catégorie de véhicule ; le lead flotte affecte un véhicule du pool après approbation.",
    ...
    sections: [
      {
        ...
        paragraphs: [
          [
            ...
            B("planifier"),
            " un déplacement et demander un ",
            B("type de véhicule"),
            " au pool au préalable, utilisez ",
            L("/vehicle-requests", "Demandes"),
            " (mission → validation → demande → affectation flotte) ; Trajets est l’enregistrement opérationnel une fois le véhicule concret connu.",
          ],
          [
      ...
      },
      {
        ...
        paragraphs: [
          [
            ...
            ", puis (conducteur agréé) soumettre une ",
            B("demande de véhicule"),
            " en indiquant seulement le ",
            B("type / catégorie"),
            " souhaité (ex. 4WD / SUV / bakkie, camion cargo)—pas un code véhicule précis. L’approbation de la demande en ligne est distincte de celle de la mission. Un ",
            B("lead flotte"),
            " affecte ensuite un véhicule du pool opérationnel.",
          ],
          [
            L("/trips", "Trajets"),
            " est différent : c’est le ",
            B("check-out opérationnel"),
            " (véhicule réel, odomètre, retour). Utilisez Demandes pour la planification et l’affectation par type ; Trajets lorsque le véhicule part réellement.",
          ],
          [
