      ...
      },
      {
        ...
        paragraphs: [
          ...
          [
            ...
            ". Le statut ",
            B("deployed"),
            " est posé automatiquement quand un trajet démarre avec le véhicule et revient à ",
            B("operational"),
            " au check-in — vous n'avez pas à le basculer manuellement. Chaque changement est inscrit dans l'historique de statut sous la carte pour l'audit.",
          ],
        ],
        bullets: [
          "Quick Status Change (page détail) : utilisez-la dès qu'un véhicule entre en atelier, en sort, est cloué au sol pour raison de sécurité, ou est réformé.",
        ],
      },
      {
        id: "trips-link",
