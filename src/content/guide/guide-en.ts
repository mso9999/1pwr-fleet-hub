  ...
  index: {
    ...
    tutorialBody: [
      [
        ...
        B("TUT-"),
        ") is created for the register walkthrough and removed when you finish or exit. The ",
        B("Field deployment (end-to-end)"),
        " track also creates a sandbox approved mission and reservation on that vehicle; any trip you start from it is removed in the same cleanup.",
      ],
      [
        "Focused tracks cover driver checks, mechanical inspections, vehicle requests (missions, type-based requests, route and fuel hints), work orders, and ",
        B("load-out manifests (AM)"),
        " — linking packing lists to trips.",
      ],
      [
        B("Field deployment (end-to-end)"),
        " walks the full path from new mission through management approval, fleet reservation, reservation calendar, departing driver checklist, mission-linked trip checkout, and AM manifests — with a ",
        B("Role"),
        " pill at each step when a different person or permission set typically takes over.",
      ],
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Trips — operational check-out / check-in (actual vehicle and odometer). Planned missions and pool logistics use Requests.",
          ...
          "Work Orders — maintenance and repair jobs (often linked from failed inspections); statuses include needs-parts and PR submitted for procurement.",
          ...
          "Requests — missions (profile, required asset class, R&R), management approval, optional driver logistics row; fleet lead reserves a pool vehicle on the mission. Management may arbitrate capacity on departure day.",
      ...
      },
      {
        ...
        paragraphs: [
          [
            ...
            " to start directly, or ",
            L("/?tutorial=field-deployment", "field deployment end-to-end"),
            " for missions → approval → reservation → driver check → trip checkout.",
          ],
        ],
      },
    ],
    ...
    sections: [
      {
        ...
        paragraphs: [
          [
            ...
            B("check-in"),
            " with end odometer and any issues so distance and fleet status stay accurate. For ",
            B("planning"),
            " a journey and locking in a ",
            B("required vehicle class on the mission"),
            ", use ",
            L("/vehicle-requests", "Requests"),
            " (mission → approval → optional logistics row → fleet reservation on the mission)—Trips is the operational record once you have a concrete vehicle.",
          ],
          [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          [
            ...
            " and ",
            B("PR submitted"),
            " to reflect procurement: parts identified, then requisition linked or in flight. Attach PR/PO lines on the work order detail as your process requires.",
          ],
        ],
      },
      {
      ...
      {
        id: "requests",
        title: "Missions and vehicle requests",
        paragraphs: [
          [
            L("/vehicle-requests", "Requests"),
            " is for planned journeys: create a ",
            B("mission"),
            " with timeframe, profile (local vs field), ",
            B("required vehicle class"),
            ", and R&amp;R; wait for ",
            B("management approval"),
            ". Approved drivers may submit a ",
            B("logistics request"),
            " so a queue row exists (purpose, priority); the vehicle class usually comes from the mission. A ",
            B("fleet team lead"),
            " ",
            B("reserves"),
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          [
            "Procurement-oriented statuses include ",
            B("needs-parts"),
            " (parts identified, purchase requisition not yet raised) and ",
            B("PR submitted"),
            " (requisition linked or submitted—waiting on approval, PO, or delivery). ",
            B("Awaiting parts"),
            " remains available for the generic “waiting on supply” state. Vehicle parts/service PRs in the PR system must reference a work order before they can reach an approver, and creating the PR registers the link here automatically (needs-parts advances to PR submitted). Fuel and consumable fluids (expense type 4F) are exempt.",
          ],
          [
            B("Labour before completion: "),
            "a work order can only be marked ",
            B("completed"),
