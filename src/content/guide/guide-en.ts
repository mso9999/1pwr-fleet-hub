    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          [
            ...
            B("Awaiting parts"),
            " remains available for the generic “waiting on supply” state. Fleet can attach PR/PO links on the work order; when the separate PR system is wired, it can register those links automatically.",
          ],
        ],
      },
      {
