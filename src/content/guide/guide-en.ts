    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Trips — operational check-out / check-in (actual vehicle and odometer). Planned missions and type-based pool requests use Requests.",
          ...
          "Requests — missions, management approval, vehicle requests by type (asset class); fleet lead assigns a pool vehicle after approval.",
    ...
    sections: [
      {
        ...
        paragraphs: [
          [
            ...
            B("planning"),
            " a journey and requesting a ",
            B("vehicle type"),
            " from the pool first, use ",
            L("/vehicle-requests", "Requests"),
            " (missions → approval → request → fleet allocation)—Trips is the operational record once you have a concrete vehicle.",
          ],
          [
      ...
      },
      {
        ...
        paragraphs: [
          [
            ...
            ", then (as an approved driver) submit a ",
            B("vehicle request"),
            " that specifies only the ",
            B("vehicle type / asset class"),
            " needed (for example 4WD SUV / bakkie or cargo truck)—not a specific vehicle code. Line approval of the request is separate from mission approval. A ",
            B("fleet team lead"),
            " allocates an operational pool vehicle after those approvals.",
          ],
          [
            L("/trips", "Trips"),
            " is different: it records an ",
            B("operational check-out"),
            " (concrete vehicle, odometer, return). Use Vehicle requests for planning and type-based allocation; use Trips when the vehicle is actually going out.",
          ],
          [
            "Only drivers on the ",
