      ...
      },
      {
        ...
        paragraphs: [
          ...
          [
            ...
            ". ",
            B("deployed"),
            " is set automatically when a trip is created with the vehicle and reverts to ",
            B("operational"),
            " on check-in, so you don't toggle it manually. Every change is appended to the status history below the card for audit.",
          ],
        ],
        bullets: [
          "Quick Status Change (detail page): use this whenever a vehicle goes into the workshop, comes out of the workshop, is grounded for safety, or is written off. The vehicle list reflects the change immediately and the dashboard status counts update on next refresh.",
