  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-3 shadow-sm">
      ...
      <input
        ...
        className="mt-2 h-11 w-full rounded-lg border border-zinc-200 px-3 text-sm"
      />
    </div>
  );
}
    ...
    <Card className="border-blue-200 shadow-md">
      <CardHeader className="pb-2">
        ...
        <p className="text-sm text-zinc-500 font-normal">
          Tablet-friendly layout — same content as the Driver Proficiency checklist. Mark Pass, Warn, or Fail for each line.
        </p>
      </CardHeader>
      <CardContent>
